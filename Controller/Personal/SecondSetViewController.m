...
#import "SecondSetViewController.h"
...
@interface SecondSetViewController ()<UITableViewDelegate, UITableViewDataSource, UIActionSheetDelegate, UIAlertViewDelegate>
/** 界面文字数据源*/
...
@implementation SecondSetViewController
