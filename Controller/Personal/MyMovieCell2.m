...
//        self.movieTitleLabel.text = order.szVideoName;
//    }
//    else
//    {
//        MovierDCInterfaceSvc_VDCVideoInfoEx *vdcINfor = (MovierDCInterfaceSvc_VDCVideoInfoEx *)self.moveData;
//        self.nickNameLabel.text = vdcINfor.szOwnerName;
//        self.movieTitleLabel.text = vdcINfor.szVideoName;
//        _lookLabel.text = [NSString stringWithFormat:@"%d",[vdcINfor.nVisitCount intValue]];
//        self.favouriteLabel.text = [NSString stringWithFormat:@"%d",[vdcINfor.nPraise intValue]];
