...
#pragma mark - 没有数据提示，或者url有错, 或者版权问题
		[self presentAlertWithTitle:NSLocalizedStringFromTable(@"", @"Errors", nil)
							message:NSLocalizedStringFromTable(@"未获得相关版权", @"Errors", nil)];
	}
}
