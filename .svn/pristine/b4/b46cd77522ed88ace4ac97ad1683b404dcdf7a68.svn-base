//
//  NGMoviePlayerCustomiPadLayout.m
//  NGMoviePlayer
//
...
#import "NGMoviePlayerCustomiPadLayout.h"
#import "NGScrubber.h"
...
#define kPlayWidth 100
#define kPlayHeigh 100

#define kAboutWidth 65
#define kAboutHeight 40

@interface NGMoviePlayerCustomiPadLayout () {
...
@implementation NGMoviePlayerCustomiPadLayout
...
- (void)setupScrubber:(NGScrubber *)scrubber controlStyle:(NGMoviePlayerControlStyle)controlStyle {
    ...
    if (controlStyle == NGMoviePlayerControlStyleFullscreen) {
        height = 10.f;
        radius = 4.f;
        [scrubber setThumbImage:[UIImage imageNamed:@"NGMoviePlayer.bundle/player_progress_slider_thumb"]
...
- (void)layoutSubviewsForControlStyleInline {
    ...
    self.scrubberControl.frame = CGRectMake(leftEdge, 6.f, rightEdge - leftEdge, controlsViewHeight);
}
...
- (void)layoutSubviewsForControlStyleFullscreen {
    ...
    self.currentTimeLabel.frame = CGRectMake(0, 5, 80, 20.f);
    self.currentTimeLabel.textAlignment = UITextAlignmentCenter;
    self.remainingTimeLabel.frame = CGRectMake(width - 80.f, 5, 80.f, 20.f);
    self.remainingTimeLabel.textAlignment = UITextAlignmentCenter;
    self.scrubberControl.frame = CGRectMake(CGRectGetMaxX(self.currentTimeLabel.frame) + 4.f, 5, self.remainingTimeLabel.frame.origin.x - CGRectGetMaxX(self.currentTimeLabel.frame) - 8.f, 20.f);
}
