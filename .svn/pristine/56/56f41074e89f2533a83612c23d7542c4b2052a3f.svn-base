...
@protocol SCViewChangeDelegate <NSObject>

@optional
/**
 *  When NavView Item will show Call Back
 *
 *  @param index - show item's index
 */
...
@property(nonatomic,assign)     BOOL        showContentView;            //Default value:YES
...
@property (nonatomic, weak)     id          <SCViewChangeDelegate>delegate;
