...
@implementation ISSpecialFlowLayout
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.item == 0) {
        CGFloat width = self.collectionView.size.width - self.rowMargin * 2;
        CGFloat height = [self.delegate waterflowLayout:self firstCellHeight:width];
        attrs.frame = CGRectMake(self.rowMargin, 0, width, height);
        return attrs;
    } else {
