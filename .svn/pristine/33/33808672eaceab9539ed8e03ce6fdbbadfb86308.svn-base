...
@property (nonatomic, strong, readwrite) UIButton *levelControl;
@property (nonatomic, strong, readwrite) UIButton *relationCotrol;
...
- (void)setMoviePlayer:(NGMoviePlayer *)moviePlayer {
    if (moviePlayer != _moviePlayer) {
        ...
        self.levelControl = moviePlayer.view.controlsView.levelControl;
        self.relationCotrol = moviePlayer.view.controlsView.relationCotrol;
        self.favoriteControl = moviePlayer.view.controlsView.favoriteControl;
        self.downloadControl = moviePlayer.view.controlsView.downloadControl;
        self.titleLabel = moviePlayer.view.controlsView.titleLabel;
    }
}
