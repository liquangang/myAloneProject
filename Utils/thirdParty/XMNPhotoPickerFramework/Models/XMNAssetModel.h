...
//collectionview使用的cell缩略图
@property (nonatomic, strong, readonly, getter=cellThumbnail, nullable) UIImage *cellThumbnail;

@property (nonatomic, strong, readonly, getter=largerThumbnail, nullable) UIImage * largerThumbnail;
...
/** 图片的url*/
@property (nonatomic, strong, nullable) NSURL * fileAssUrl;
/** 图片的url的nsstring*/
